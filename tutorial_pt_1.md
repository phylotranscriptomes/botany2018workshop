...
**Enter your cyverse password when asked**
...
Notice that the format of the sequences is *taxonID@seqID*. The special character "@" is used to separate taxonID and seqID.
